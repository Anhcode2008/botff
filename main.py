...
#━━━━━━━━━━━━━━━━━━━━━━━━━━
#PUBLISH CHANNEL: DaNGeR_lll
#CHANNEL USERNAME: @DaNGeR_lll
#গেরেনার পুটকি মারছে : @abirH50
#━━━━━━━━━━━━━━━━━━━━━━━━━━
            ...
            while True:
                ...
                if data.hex().startswith("120000"):
                    ...
                    if response:
                        ...
                        if inPuTMsG in ("hi" , "help" , "/help" , "salam" , "abir" , "bot"):
                            uid = response.Data.uid
                            chat_id = response.Data.Chat_ID
                            message = '/a/teamcode ━ Join the Group\n Leave ━ Leave the group\n @a emote id player ids ━ Show Emote\n telegram ━ @DaNGeR_lll\n @abirH50'
                            P = await SEndMsG(response.Data.chat_type , message , uid , chat_id , key , iv)
                            await SEndPacKeT(whisper_writer , online_writer , 'ChaT' , P)
                        response = None
...
async def MaiiiinE():
    Uid , Pw = '4388588231','PAN7754OD_SyhbH'
    ...
    os.system('clear')
    print(render('ABIR 53', colors=['white', 'red'], align='center'))
    print('')
    #print(' - ReGioN => {region}'.format(region))
    print(f" - BoT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | ABIR TCP ! (:")    
    print(f" - TELEGRAM > ABIR | File by @DaNGeR_lll ! (:")    
